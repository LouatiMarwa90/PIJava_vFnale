...
public class Participation {
    ...
    public boolean equals(Object o) {
        ...
        return id_p == that.id_p && age == that.age && Objects.equals(nom_p, that.nom_p) && Objects.equals(prenom_p, that.prenom_p) && Objects.equals(email, that.email) && Objects.equals(event, that.event) && Objects.equals(user, that.user);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id_p, nom_p, prenom_p, age, email, event, user);
    }
}
